...
def accuracy_from_loader(algorithm, loader, weights, centroids, debug=False):
    correct = 0
    total = 0
    losssum = 0.0
    weights_offset = 0
...
def accuracy(algorithm, loader_kwargs, weights, centroids,  **kwargs):
    ...
    return accuracy_from_loader(algorithm, loader, weights, centroids,  **kwargs)
...
class Evaluator:
    ...
    def evaluate(self, algorithm, centroids, ret_losses=False):
